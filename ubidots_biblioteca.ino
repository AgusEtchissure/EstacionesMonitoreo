...
#define CO2_bib "co2_bib"
#define O3_bib "ozono_bib"  // Put here your Variable label to which data  will be published
#define CO_bib "co_bib"
#define temperatura_bib "temperatura_bib"
#define humedad_bib "humedad_bib"  // Put here your Variable label to which data  will be published
...
void loop() {
  if (SerialPort2.available() > 0) {           // Si hay datos disponibles en el puerto serial
    ...
    embebido.add(temperatura_bib, temp);
    embebido.add(humedad_bib, hum);
    embebido.add(O3_bib, o3);
    embebido.add(CO_bib, monoxido);
    embebido.add(CO2_bib, dioxido);
